...
<?php if( $page_template_slug == 'page-homepage-layout-1.php' ): ?>
	...
	<?php if( !empty($hp1_tile_8_bg_image) ): ?>
		<div class="threecol grid gridbg grayscale" id="twitter_feed_tile" style="background-image: url(<?php echo $hp1_tile_8_bg_image['url']; ?>);">Twitter Carousel</div>
	<?php endif; ?>
...
<?php if( $page_template_slug == 'page-homepage-layout-2.php' ): ?>
	...
	<?php if( !empty($hp2_tile_5_bg_image) ): ?>
		<div class="threecol grid gridbg grayscale" id="twitter_feed_tile" style="background-image: url(<?php echo $hp2_tile_5_bg_image['url']; ?>);">Twitter Carousel</div>
	<?php endif; ?>
...
<?php if( $page_template_slug == 'page-homepage-layout-3.php' ): ?>
	...
	<?php if( !empty($hp3_tile_3_bg_image) ): ?>
		<div class="threecol grid gridbg grayscale" id="twitter_feed_tile" style="background-image: url(<?php echo $hp3_tile_3_bg_image['url']; ?>);">Twitter Carousel</div>
	<?php endif; ?>
