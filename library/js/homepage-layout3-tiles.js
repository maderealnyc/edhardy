// HOMEPAGE LAYOUT 3 TILES

var TILE_IDS = [ 1, 2, 3, 4, 5 ];
...
$(function() {
    ...
    var el = document.getElementById('homepage-layout3-grid'),
    ...
    var $templateButtons = $('#homepage-layout3-templates .dev-template').on('click', function(e) {
    ...
    $('#homepage-layout3-t1').trigger('click');
